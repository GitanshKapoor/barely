...
The platform now uses **PostgreSQL** by default for production-grade telemetry. The `docker-compose.yml` automatically spins up a `postgres:15-alpine` container (`barely-db`) to persist your test metadata!
